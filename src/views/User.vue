<template>
  <div>
    <div class="margin">
      <el-input size="small" class="text" placeholder="请输入名称" suffix-icon="el-icon-search"
                v-model="username"></el-input>
      <el-input size="small" placeholder="请输入邮箱" suffix-icon="el-icon-message" class="ml-5 text"
                v-model="email"></el-input>
      <el-input size="small" placeholder="请输入地址" suffix-icon="el-icon-position" class="ml-5 text"
